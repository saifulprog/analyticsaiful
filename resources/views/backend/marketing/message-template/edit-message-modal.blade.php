<div class="modal fade" id="editModal{{ $sItem->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        ...
        <form method="POST" action="{{ route('message-template.update',$sItem->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
        <div class="modal-body">
            ...
            <div class="row mb-2">
                <div class="col-sm-10">
                    ...
                    <input type="text" name="txtTitle" value="{{ $sItem->title }}" class="form-control" max="255" required>
                </div>
            ...
            <div class="row mt-2">
                <div class="col-sm-12 mb-2">
                    ...
                    <input type="text" name="txtSubject" value="{{ $sItem->subject }}" class="form-control" max="255" required>
                </div>

                <div class="col-sm-12">
                    <label class="text-secondary">Message</label>
                    <textarea name="txtMessage" class="ckeditor form-control" id="text-box" required>{{ $sItem->message }}</textarea>
                </div>
            </div>            
