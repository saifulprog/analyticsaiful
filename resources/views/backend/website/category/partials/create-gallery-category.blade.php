    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">New Gallery Category</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>

        <form method="post" action="{{route('gallery-category.store')}}" enctype="multipart/form-data">
            @csrf
        <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <input id="txtTitle" type="text" class="form-control @error('txtTitle') is-invalid @enderror" name="txtTitle" value="{{ $role->txtTitle ?? old('txtTitle') }}" maxlength="60">
